...
A round **closes** only when every question in it has a settled answer. A reply that asks you something back, or hedges rather than deciding, leaves that question open: answer what the user raised, re-put the open question, and wait. The frontier moves only from a closed round.
